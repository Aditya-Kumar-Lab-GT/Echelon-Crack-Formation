...
Point(5) = {0, 0, Lz, 2.0};     
Point(6) = {Lx, 0, Lz, 2.0};    
Point(7) = {Lx, Ly, Lz, 2.0};   
Point(8) = {0, Ly, Lz, 2.0};   

// Crack-related points
Point(9)  = {0, Ly/2-h/2, Lz, 2.0};     
Point(10) = {0, Ly/2+h/2, Lz, 2.0};    
Point(11) = {CrackZ, Ly/2, Lz, 2.0};  

Point(12) = {0, Ly/2-h/2, 0, 2.0};     
Point(13) = {0, Ly/2+h/2, 0, 2.0};    
Point(14) = {CrackZ, Ly/2, 0, 2.0};   
...
// Mesh refinement field near crack
Field[1] = Box;
Field[1].VIn = 0.25; 
Field[1].VOut = 2.0;
Field[1].XMin = CrackZ - 2;
Field[1].XMax = CrackZ + 8;
Field[1].YMin = Ly/2 - 4;
Field[1].YMax = Ly/2 + 4;
Field[1].ZMin = 0;
Field[1].ZMax = Lz;
